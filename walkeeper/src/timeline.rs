...
//! persistency and support for interaction between sending and receiving wal.
...
impl Timeline {
    ...
    pub fn get_info(&self) -> SafeKeeperState {
        return self.mutex.lock().unwrap().sk.s.clone();
    }
...
impl GlobalTimelines {
    ...
    pub fn get(
        ...
        match timelines.get(&timeline_id) {
            ...
            None => {
                info!("creating timeline dir {}, create is {}", timeline_id, create);
